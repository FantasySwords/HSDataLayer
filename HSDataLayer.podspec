#
#  Be sure to run `pod spec lint HSDataLayer.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/cnthinkcode/HSDataLayer.git", :tag => "0.0.1" }
  ...
  s.source_files  = "HSDataLayer/HSDataLayer/**/*.{h,m}"
